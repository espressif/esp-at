...
- ESP32 Series
  - Recommended released version: [v3.2.1.0](https://github.com/espressif/esp-at/releases/tag/v3.2.1.0)
...
- ESP32 系列
  - 推荐使用的发布版本：[v3.2.1.0](https://github.com/espressif/esp-at/releases/tag/v3.2.1.0)
