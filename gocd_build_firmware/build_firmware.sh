...
export IDF_PATH=/mnt/ss3_fw_source/esp-idf

# Parse the version.h file generated by GoCD/Rake
MAJOR=$(awk '/#define MAJOR/{ print $3 }' /mnt/ss3_fw_source/main/version.h)
MINOR=$(awk '/#define MINOR/{ print $3 }' /mnt/ss3_fw_source/main/version.h)
PATCH=$(awk '/#define PATCH/{ print $3 }' /mnt/ss3_fw_source/main/version.h)
BUILD=$(awk '/#define BUILD/{ print $3 }' /mnt/ss3_fw_source/main/version.h)
COMMIT_HASH=$(sed -n 's/#define COMMIT_HASH 0x//p' /mnt/ss3_fw_source/main/version.h)
