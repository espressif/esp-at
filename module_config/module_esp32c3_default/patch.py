...
def main():
    ...
    patch_list = {
        '0001-esp_hw_support-clk_cali-fix-xtal32k-error-detect.patch': os.path.join(cur_abs_dir, 'esp-idf'),
        '0002-esp_hw_support-clk_cali-remove-redundant-check-for-c.patch': os.path.join(cur_abs_dir, 'esp-idf')
    }
