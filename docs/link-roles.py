...
def setup(app):
    ...
    baseurl = 'https://github.com/espressif/esp-at'
    app.add_role('at', autolink('{}/tree/{}/%s'.format(baseurl, rev)))
    app.add_role('at_file', autolink('{}/blob/{}/%s'.format(baseurl, rev)))
    app.add_role('at_raw', autolink('{}/raw/{}/%s'.format(baseurl, rev)))
