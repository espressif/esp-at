...
To learn more about ESP-AT, please read :doc:`What_is_ESP-AT`.

To get started with ESP-AT, please read :doc:`Technology_selection` first to help you select hardware and software, and then read :doc:`Hardware_connection` to learn what hardware to prepare and how to connect them. Then, you can download and flash AT firmware into your device according to :doc:`Downloading_guide`.
