...
Since the esp-at project supports different module, for example, WROOM-32, WROVER-32, when compiling the esp-at project, users can set different configurations to generate AT firmware for different ESP modules. The detailed information are in the `esp-at/module_config` directory.  
