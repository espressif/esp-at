...
{IDF_TARGET_COMPILE_MNAME: default="undefined", esp32="WROOM-32", esp32c3="MINI-1", esp32c2="ESP32C2-4MB", esp32c5="ESP32C5-4MB", esp32c6="ESP32C6-4MB", esp32c61="ESP32C61-4MB", esp32s2="MINI"}
...
但是，在某些特殊情况下，ESP-IDF 的小版本更新也可能适用于 ESP-AT 工程。如果你需要更新，本文档可作为参考。
...
如果你想为 ESP-AT 固件更新 ESP-IDF 版本，请按照以下步骤操作。
