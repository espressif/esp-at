...
使用 SPI master 与 ESP 设备运行的 SPI slave 进行通信的示例代码请参考 `AT ESP32 SPI Master Example <https://github.com/espressif/esp-at/tree/master/examples/at_spi_master/spi/esp32_series>`_。
...
- 使用 ESP32-DevKitC 开发板作为 SPI master，运行 `ESP-AT <https://github.com/espressif/esp-at>`_ 中的 :example:`at_spi-master/spi/esp32_series` 目录的代码。其软硬件配置如下：
